@php
    $logoSvg = '<svg width="160" height="36" viewBox="0 0 160 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<head>
  ...
  <title>Отчёт Автотеки - {{ $offer['mark']['title'] }} {{ $offer['folder']['title'] }}, {{ $offer['year'] }}</title>
</head>
<style>
  @font-face {
    font-family: 'EuclidCircularB';
    src: url({{ storage_path('fonts/pdf/EuclidCircularB-Medium.ttf') }}) format("truetype");
    font-weight: 700;
    font-style: normal;
  }
  @font-face {
    font-family: 'Lato';
    src: url({{ storage_path('fonts/pdf/latoregular.ttf') }}) format("truetype");
    font-weight: 400;
    font-style: normal;
  }
  * {
  ...
  body {
    font-family: Lato, DejaVu Sans ,Verdana,Arial,sans-serif;
    padding: 64px;
    position: relative;
  }
  .inline {
  ...
  .mark {
    ...
    font-family: EuclidCircularB,Tahoma,Verdana,Arial,sans-serif;
  }
  .icon {
    width: 8px;
    position: relative;
...
<table style="width: 100%; border: 0;">
  <tr>
    <td>
     <img src="{{asset('img/autoteka/logo.png')}}" alt="logo autoteka" class="logo">
    </td>
    <td>
      <div class="ml-16 inline">
        <div style="font-size: 14px;">
          <b>
            Отчёт куплен на сайте Autoteka.ru
          </b>
        </div>
        <div class="mt-8e" style="font-size: 14px;">
          <p>Автотека - сервис по проверке автомобиля по VIN</p>
        </div>
      </div>
    </td>
  </tr>
...
<div class="mt-32">
  <div >
    <p style="margin-bottom: 0; padding-bottom: 0;">Отчёт от {{Date::now()->subDay()->format('j F Y г.') }}</p>
  </div>
  <div class="mark">{{$offer['mark']['title']}} {{$offer['folder']['title']}}, {{$offer['year']}} </div>
</div>
<div class="mt-16">
  <div class='photo'>
    <img src="{{$offer['images'][0]['original']}}" class="photo" style="" alt="">
  </div>
</div>

<table class="mt-32" style="width: 100%; border: 0;">
  <tr>
    <td class="td-line">
      <p>VIN:</p>
    </td>
  ...
  <tr>
    ...
    <td class="td-line">
      <p><b>@engine($offer['engine_volume']) л.</b></p>
    </td>
  ...
  <tr>
    ...
    <td class="td-line">
      <p><b>@engine($offer['engine_power']) л.с.</b></p>
    </td>

  </tr>
  <tr>
    <td class="td-line">
      <p>Последний пробег:</p>
    </td>
    <td class="td-line">
      <p><b>@number($offer['run']) км</b></p>
    </td>

  </tr>
</table>
<p class="mt-8">VIN номер скрыт из соображений безопасности.</p>
<div class="line mt-32 align-center foot">
  <img src="{{asset('img/autoteka/logo.png')}}" alt="" style="width: 90px">
  <div class="ml-24 inline autoteka__text">
    <div>
      <p>Автотека - сервис по проверке автомобиля по VIN и госномеру</p>
    </div>
  </div>
</div>
...
<div class="info__block">
  <div style="width: 100%"><p><b>Сводка по автомобилю</b></p></div>
  <div class="clear"></div>
  <table style="width: 100%; border: 0;">
    <tr>
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Не найдены ограничения на регистрацию</p>
      </td>
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Не найдено разрешение на работу в такси</p>
      </td>
    </tr>
    <tr>
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Нет сведений о розыске</p>
      </td>
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Не найдены сведения об использовании в каршеринге</p>
      </td>
    </tr>
    <tr>
      <td class="li-line li-line--start">
      ...
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Пробег - @number($offer['run']) км</p>
      </td>
    </tr>
    <tr>
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>@owner($offer['owner']['number']) по ПТС</p>
      </td>
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Не найдены сведения о техосмотрах</p>
      </td>
    </tr>
    <tr>
      <td class="li-line li-line--start">
      ...
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Нет полиса ОСАГО</p>
      </td>
    </tr>
    <tr>
      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Не найдены расчёты стоимости ремонта</p>
      </td>

      <td class="li-line li-line--start">
        <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon" alt="icon" />
        <p>Не найдены сведения об отзывных кампаниях</p>
      </td>
    </tr>
  </table>
  <div class="clear"></div>
  <div class="mt-16">
    ...
    <div class="mt-8" style="margin-left: 26px">
  ...
  <div class="mt-32">
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b> Нет сведений о розыске </b>
    </div>
    <div>
      <p class="mt-8 ml-26"> Покупка разыскиваемого автомобиля грозит тем, что его отберут в ГИБДД при регистрации, и пока будет идти следствие, а это может затянуться на долгий срок, автомобиль будет стоять на штрафплощадке. </p>
    </div>
  </div>
  <div class="mt-32">
    <div class="title__line">
    ...
    <div>
      <p class="mt-8 ml-26"> Мы проверили базы данных Федеральной нотариальной палаты (ФНП) и Национального бюро кредитных историй (НБКИ). </p>
    </div>
  </div>
  <div class="mt-32">
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b> @owner($offer['owner']['number']) по ПТС </b>
    </div>
  </div>
  <div class="mt-32">
    <div class="title__line">
    ...
    <div>
      <p class="mt-8 ml-26">В отчёт не попадут аварии, которые произошли раньше 2015 года или не оформлялись в ГИБДД.</p>
    </div>
  </div>
  <div class="mt-32">
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b> Не найдены расчёты стоимости ремонта </b>
    </div>
    <div>
      <p class="mt-8 ml-26"> Мы проверяем, во сколько эксперты страховых компаний оценили восстановление автомобиля после ДТП. Расчёт не означает, что машину ремонтировали.
      </p>
    </div>
  </div>
  <div class="mt-32">
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b> Не найдено разрешение на работу в такси </b>
    </div>
    <div>
      <p class="mt-8 ml-26"> Данные представлены из региональных баз по регистрации автомобиля в качестве такси. </p>
    </div>
  </div>
  <div class="line mt-32 align-center foot">
    <img src="{{asset('img/autoteka/logo.png')}}" alt="" style="width: 90px">
  ...
  <div>
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b> Не найдены сведения об использовании в каршеринге
      </b>
    </div>
    <div>
      <p class="mt-8 ml-26"> На каршеринговых авто ездят практически круглосуточно. Они много времени проводят в пробках - от этого двигатель и сцепление быстро изнашиваются. Салон тоже страдает от большого количества водителей и пассажиров.
      </p>
    </div>
  </div>
  <div class="mt-32">
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b>Не найдены сведения о диагностике</b>
    </div>
    <div>
      <p class="mt-8 ml-26">В ходе диагностики специалисты проверяют состояние ЛКП, всех конструкций автомобиля, состояние салона, фактическую комплектацию и проводят небольшой тест-драйв.</p>
    </div>
  </div>
  <div class="mt-32">
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b>Не найдены сведения о техосмотрах</b>
    </div>
    <div>
      <p class="mt-8 ml-26">
        @if(date('Y') - $offer['year'] <= 4)
          Автомобиль ещё не проходил техосмотр так как его возраст менее 4-х лет.<br><br>
        @endif
        В данном блоке отображаются данные о прохождении техосмотра на основании данных диагностических карт ТС.
        <br><br> Срок прохождения технического осмотра для автомобилей категории "B": - первые четыре года - не требуется; - возраст от 4 до 10 лет - каждые 2 года; - старше 10 лет - ежегодно.
      </p>
    </div>
  </div>
  ...
  <div class="mt-32">
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b>Нет полиса ОСАГО</b>
    </div>
  </div>
  <div class="mt-32">
    <div class="title__line">
      <img src="{{asset('img/autoteka/icon-check-autoteka.svg')}}" class="icon"  alt="icon" />
      <b>Не найдены сведения об отзывных кампаниях</b>
    </div>
    <div>
      <p class="mt-8 ml-26">Для данного автомобиля не проводилось или нет действующих отзывных кампаний. Отзыв автомобиля представляет собой устранение выявленного брака. Практически все автомобильные производители периодически отзывают свои продукты для устранения дефектов.</p>
    </div>
  </div>
